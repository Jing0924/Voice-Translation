...
if __name__ == "__main__":
    ...
    # 翻譯文本為法文
    translated_text_fr = translate_text(text, target_language='fr')
    print(f"Translated text (French): {translated_text_fr}")
    
    # 將翻譯後的文本轉換為語音
    audio_output = "output_fr_audio.wav"
    audio_path = text_to_speech(translated_text_fr, lang='fr', output_file=audio_output)
